...
{
    class DisassociatePTfromCompanypoolTest
    {

        
        [Test]
        public void TC2004989_DisassociatePaymentTerminalfromCompanypool()
        {
            ...
            using (JsonTextReader reader = new JsonTextReader(file))
            {
                ...
                globals.expRpt.logReportStatement(AventStack.ExtentReports.Status.Pass, "Click Disassociate Payment Terminal from Lane");
                maintenance.clickdisassociatePT();

                globals.expRpt.logReportStatement(AventStack.ExtentReports.Status.Pass, "Disassociate Payment Terminala to Company pool Sucessfully");
